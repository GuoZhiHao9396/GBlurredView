...
public class BlurredView extends RelativeLayout {
     ...
     * 图片显示模式
     */
    private BlurredViewScaleType mScaleType = BlurredViewScaleType.CENTER_CROP;
    ...
    private void setImageView() {
        ...
        mBlurredImg.setScaleType(mScaleType == BlurredViewScaleType.CENTER_CROP ? ImageView.ScaleType.CENTER_CROP : ImageView.ScaleType.FIT_XY);
        mOriginImg.setScaleType(mScaleType == BlurredViewScaleType.CENTER_CROP ? ImageView.ScaleType.CENTER_CROP : ImageView.ScaleType.FIT_XY);
    }
     ...
     * @param scaleType
     */
    public void setBlurredScaleType(BlurredViewScaleType scaleType) {
